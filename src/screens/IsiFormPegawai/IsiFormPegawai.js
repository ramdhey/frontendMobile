  ...
  const handleSubmit = async () => {
    const payload = {
      ...
      work_experience: experienceFields.map(exprience => ({
        ...
        pendapatan_terakhir: exprience.pendapatanTerakhir,
          ...
          <View
            ...
            <PickerCustom
              ...
              items={[
                ...
                {label: 'Duda', value: 'widowedMale'},
                {label: 'Janda', value: 'widowedFemale'},
              ]}
              borderColor={theme.text}
              backgroundColor={theme.background}
              colorTxt={theme.text}
